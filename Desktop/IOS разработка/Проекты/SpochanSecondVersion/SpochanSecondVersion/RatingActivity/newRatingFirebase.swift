...
//тут посмотри как в андройде и разберись, так как там в базе данных немного необычно представлены значения

//extension appNew {
//    static func build(from documents: [QueryDocumentSnapshot]) -> [appNew] {
//        var appNews = [appNew]()
//        for document in documents {
//            appNews.append(appNew(newsTitle: document["newsTitle"] as? String ?? "",
